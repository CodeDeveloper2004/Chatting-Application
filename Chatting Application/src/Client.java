    ...
    static JPanel p2;
        static JFrame frame=new JFrame();
                ...
                public Client(){
                    ...
                    ImageIcon i4=new ImageIcon(ClassLoader.getSystemResource("./Bheem.jpg"));
                    ...
                    //frame.setUndecorated(true); used to remove java icon in top most
                ...
                public static void main(String[] args) throws Exception {
                    ...
                    try{
                        Socket s=new Socket("127.0.0.1",6001);//localhost,serverport
